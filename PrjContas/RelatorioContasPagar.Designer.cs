namespace PrjContas
{
    partial class RelatorioContasPagar
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(RelatorioContasPagar));
            ...
            this.tb_contas_pagarTableAdapter = new PrjContas.db_contasDataSet1TableAdapters.tb_contas_pagarTableAdapter();
            ...
            this.tb_contas_pagarBindingSource.DataSource = this.db_contasDataSet1;
            // 
            // db_contasDataSet1
            // 
            ...
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "PrjContas.Report4.rdlc";
            ...
            this.Name = "RelatorioContasPagar";
            this.Text = "Relatório de contas a pagar";
            this.Load += new System.EventHandler(this.RelatorioContasPagar_Load);
        ...
        private db_contasDataSet1TableAdapters.tb_contas_pagarTableAdapter tb_contas_pagarTableAdapter;
    }
}